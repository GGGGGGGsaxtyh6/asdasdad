...
from .test_base import APITestBase, smoke_test, regression_test, api_test
from .validators import USER_SCHEMA, API_ERROR_SCHEMA
...
class TestUsersAPI(APITestBase):
    ...
    def test_update_user_success(self):
        ...
        update_data = {
            ...
            "email": "actualizado@eci.com"
        }
        
        response = self.client.put(f"{self.endpoint}/{self.user_id}", json_data=update_data)
    ...
    def test_concurrent_requests(self):
        ...
        for response in responses:
            self.assert_status_code(response, 200)
            self.assert_response_time(response, 3.0)  # Tiempo más generoso para concurrencia
