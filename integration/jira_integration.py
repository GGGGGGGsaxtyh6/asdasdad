...
class JiraIntegration:
    ...
    def create_test_execution_issue(
        ...
        issue_dict = {
            ...
            "labels": ["testing", "automation", execution.test_suite, execution.environment]
        }
    ...
    def create_test_failure_issue(
        ...
        issue_dict = {
            ...
            "issuetype": {"name": "Bug"},
            "priority": {"name": "High" if test_result.test_type == "api" else "Medium"},
            "labels": ["testing", "failure", test_result.test_type, test_result.environment]
        }
...
"""
    ...
    def _format_failure_description(self, test_result: TestResult, execution_id: str) -> str:
...
"""
    ...
    def _format_test_plan_description(self, description: str, test_cases: List[str]) -> str:
...
class JiraReporter:
    ...
    def report_test_execution(
        ...
        if execution.failed_tests == 0:
            self.jira.update_test_execution_status(execution_issue_key, "Done", "All tests passed successfully")
        else:
            self.jira.update_test_execution_status(execution_issue_key, "In Progress", f"{execution.failed_tests} tests failed")
    ...
    def report_test_plan(
        ...
        return self.jira.create_test_plan_issue(test_plan_name, description, test_cases, assignee)
