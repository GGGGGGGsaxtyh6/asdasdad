...
def solve_private_key_direct_math():
    """Solve for private key using direct mathematical approach"""
    print("Solving for private key using direct mathematical approach...")
    ...
    for d in range(1, min(2**6, q)):  # Very small search space for testing
        if d % 5 == 0:
            print(f"Testing d = {d}")
...
def main():
    ...
    privkey_d = solve_private_key_direct_math()
