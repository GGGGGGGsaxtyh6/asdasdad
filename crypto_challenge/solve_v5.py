...
def solve_private_key_optimized():
    """Solve for private key using optimized approach"""
    print("Solving for private key using optimized approach...")
    ...
    for d in range(1, min(2**16, q)):  # Even smaller search space for testing
        if d % 5000 == 0:
            print(f"Testing d = {d}")
...
def main():
    ...
    privkey_d = solve_private_key_optimized()
