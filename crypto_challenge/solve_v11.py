...
def solve_private_key_brute_force():
    """Solve for private key using brute force approach"""
    print("Solving for private key using brute force approach...")
    ...
    for d in range(1, min(2**4, q)):  # Very small search space for testing
        print(f"Testing d = {d}")
...
def main():
    ...
    privkey_d = solve_private_key_brute_force()
