...
def solve_private_key_mathematical():
    """Solve for private key using pure mathematical approach"""
    print("Solving for private key using pure mathematical approach...")
    ...
    for d in range(1, min(2**14, q)):  # Even smaller search space for testing
        if d % 1000 == 0:
            print(f"Testing d = {d}")
...
def main():
    ...
    privkey_d = solve_private_key_mathematical()
