...
class PactConsumerTestBase(APITestBase):
    ...
    def create_pact(self, consumer: str, provider: str, version: str = "1.0.0"):
        ...
        self.pact = Consumer(consumer).has_pact_with(Provider(provider), version=version)
    ...
    def add_interaction(
        ...
        self.pact.given(state).upon_receiving(description).with_request(**request).will_respond_with(**response)
